...
const ko = {
  ...
  auth: {
    ...
    signingUp: "가입 중...",
    signOut: "로그아웃",
    signInHint: "계정이 없으면 회원가입 탭을 이용하세요.",
    signUpHint: "가입 시 기본 권한은 조회 전용(viewer)입니다. 관리자가 역할을 변경할 수 있습니다.",
    signUpConfirmEmail: "가입 확인 메일을 발송했습니다. 이메일을 확인한 후 로그인해주세요.",
    passwordMismatch: "비밀번호가 일치하지 않습니다.",
    passwordTooShort: "비밀번호는 6자 이상이어야 합니다.",
    noMenuAccess: "접근 가능한 메뉴가 없습니다. 관리자에게 권한을 요청하세요.",
  },
  roles: {
    admin: "관리자",
    manager: "매니저",
  ...
  users: {
    title: "계정 관리",
    hint: "등록된 사용자의 역할(권한)을 변경할 수 있습니다. 관리자 전용 메뉴입니다.",
    email: "이메일",
    role: "역할",
    joined: "가입일",
    actions: "작업",
    ...
    roleUpdated: "{email} 사용자의 역할이 변경되었습니다.",
    cannotDemoteSelf: "본인 계정의 관리자 권한은 스스로 해제할 수 없습니다.",
    footerNote:
      "신규 사용자는 회원가입 후 목록에 표시됩니다. 비밀번호 초기화·계정 삭제는 Supabase 대시보드에서 처리하세요.",
  },
  common: {
    close: "닫기",
    loading: "불러오는 중...",
...
const en = {
  ...
  auth: {
    ...
    signOut: "Sign Out",
    signInHint: "Don't have an account? Use the Sign Up tab.",
    signUpHint: "New accounts start as viewer (read-only). An administrator can change your role.",
    signUpConfirmEmail: "Confirmation email sent. Please verify your email, then sign in.",
    passwordMismatch: "Passwords do not match.",
    passwordTooShort: "Password must be at least 6 characters.",
    noMenuAccess: "No menus available for your role. Contact an administrator.",
  },
  roles: {
    admin: "Administrator",
    manager: "Manager",
  ...
  users: {
    ...
    hint: "Change roles (permissions) for registered users. Administrators only.",
    email: "Email",
    role: "Role",
    joined: "Joined",
    actions: "Actions",
    ...
    footerNote:
      "New users appear after sign-up. Reset passwords or delete accounts in the Supabase dashboard.",
  },
  common: {
    close: "Close",
    loading: "Loading...",
